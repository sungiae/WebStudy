...
public class EmpDAO {
	...
	private final String URL="jdbc:oracle:thin:@211.238.142.202:1521:XE"; //오라클 주소
	...
	// 기능 처리 (DML처리)
	public ArrayList<EmpVO> empAllData() // 14명의 데이터를 테이블로 모아서 넘겨주겠다
	{
